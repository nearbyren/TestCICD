...
class NotificationActivity : AppCompatActivity() {
    ...
    private fun setClickListener() {
        ...
        findViewById<MaterialButton>(R.id.mb_normal).setOnClickListener {
            createNotificationForNormal()
        }

        findViewById<MaterialButton>(R.id.mb_high).setOnClickListener {
            createNotificationForHigh()
        }

        findViewById<MaterialButton>(R.id.mb_progress).setOnClickListener {
            createNotificationForProgress()
        }

        findViewById<MaterialButton>(R.id.mb_update_progress).setOnClickListener {
            updateNotificationForProgress()
        }

        findViewById<MaterialButton>(R.id.mb_big_text).setOnClickListener {
            createNotificationForBigText()
        }

        findViewById<MaterialButton>(R.id.mb_big_image).setOnClickListener {
            createNotificationForBigImage()
        }

        findViewById<MaterialButton>(R.id.mb_custom).setOnClickListener {
            createNotificationForCustom()
        }

        findViewById<MaterialButton>(R.id.mb_update_custom).setOnClickListener {
    ...
    private fun createNotificationForBigImage() {
        val bigPic = BitmapFactory.decodeResource(resources, R.mipmap.ic_avatar)
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                mBigImageChannelId,
    ...
    private fun updateCustomView() {
        ...
        if (mIsStop) {
            ...
            findViewById<MaterialButton>(R.id.mb_update_custom).text = "继续"
        } else {
            views.setTextViewText(R.id.tv_status, "那些你很冒险的梦-正在播放")
            views.setTextViewText(R.id.btn_stop, "暂停")
            findViewById<MaterialButton>(R.id.mb_update_custom).text = "暂停"
        }
